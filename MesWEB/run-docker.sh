...
echo "========================================"
echo "Crystal Growth Notebook 2 - Docker Build"
echo "========================================"
...
docker build -f Dockerfile.simple -t crystalgrowthnotebook2:latest .
...
docker rm -f crystalgrowthnotebook2 2>/dev/null || true
...
echo "  docker logs -f crystalgrowthnotebook2  # View logs"
echo "  docker stop crystalgrowthnotebook2     # Stop container"
echo "  docker start crystalgrowthnotebook2    # Start container"
echo "  docker rm -f crystalgrowthnotebook2    # Remove container"
